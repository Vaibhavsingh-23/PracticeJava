...
class Q4561 {
    public static void main(String args[]) throws Exception {
        try (Connection con = DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/mca", "root", "vaibhav12@")) {
           ...
           /* String createTableSQL = "CREATE TABLE IF NOT EXISTS EmployeeTable1 ("
            ...
            String insertValuesSQL = "INSERT INTO EmployeeTable1 (employee_name, employee_city, salary, date_of_joining) "
            ...
            ResultSet rs = stmt.executeQuery("SELECT * FROM EmployeeTable1");
            if (rs.first()) {
